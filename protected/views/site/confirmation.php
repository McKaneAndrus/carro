...
?>
		...
		<script type="text/javascript">
		  ...
		  ga('send', 'pageview' , {'page':'/Confirmation', 'title':'Confirmation Page'});
		</script>
		...
		<script type="text/javascript">
		  (function () {
			...
			tagjs.async = true;
			tagjs.src = "//s.btstatic.com/tag.js#site=Srkzd7l";
			s.parentNode.insertBefore(tagjs, s);
		  }());
		</script>
		<noscript>
		  <iframe src="//s.thebrighttag.com/iframe?c=Srkzd7l" width="1" height="1" frameborder="0" scrolling="no" marginheight="0" 
